              ...
              <div>
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    className="relative z-10 bg-gradient-to-br from-[var(--accent)] to-[#0052A3] text-white px-6 py-3 rounded-lg font-semibold cursor-pointer border-none transition-all hover:shadow-[0_4px_15px_rgba(0,102,204,0.3)]"
                  >
                    Analyze
                  </button>
                </div>
