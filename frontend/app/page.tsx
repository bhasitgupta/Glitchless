  ...
  return (
    <>
          ...
          >
            <div className="mb-6 leading-tight">
              ...
              <KineticTextReveal 
                ...
                className="text-4xl md:text-6xl font-bold mt-2 text-[var(--accent)]" 
                staggerDelay={0.03}
              />
            </div>
            <WordReveal 
      ...
      <motion.div 
        ...
        transition={{ duration: 0.8 }}
      >
        {/* Centered Giant Glitchless Logo with Levitation */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="flex flex-col items-center gap-6 animate-[levitate_4s_ease-in-out_infinite]" style={{ perspective: '1000px' }}>
            <div className="relative" style={{ transformStyle: 'preserve-3d', transform: 'rotateY(15deg) rotateX(10deg)' }}>
              <Image 
                src="/logo.png" 
                alt="Glitchless Logo" 
                width={160} 
                ...
                style={{ 
                  filter: 'drop-shadow(0 0 10px rgba(0, 242, 255, 0.8)) drop-shadow(0 0 20px rgba(0, 242, 255, 0.6)) drop-shadow(0 0 40px rgba(0, 242, 255, 0.4))' 
                }}
              />
            </div>
        ...
        <div className="max-w-[1200px] mx-auto px-8">
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              >
                <h2 
                  className="text-4xl md:text-5xl font-black text-white transition-all duration-500 group-hover:scale-105 inline-block"
                ...
                <div 
                  className="absolute inset-0 flex items-center justify-center opacity-20 blur-sm pointer-events-none"
                  style={{
              ...
              <p className="text-[var(--accent)] text-sm mt-2 transition-opacity">
